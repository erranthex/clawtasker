  ...
  box.innerHTML=`
    ...
    <div class="mo-body">
      ...
      <div>
        ...
        <div style="font-size:.65rem;color:var(--mut);margin-top:4px">AI agents: <code>POST /api/tasks/comment</code></div>
      </div>
...
function submitTaskEdit(id){
  ...
  apiPost('/api/tasks/update',{id,title:t.title,description:t.description,status:t.status,
